...
const Ixtal = ['Malphite', 'Neeko', 'Milio', 'Nidalee', 'Qiyana', 'Rengar', 'Zyra']
const Targon = ['Aphelios', 'AurelionSol', 'Diana', 'Leona', 'Pantheon', 'Soraka', 'Taric', 'Zoe']
const BandleCity = ['Corki', 'Lulu', 'Rumble', 'Teemo', 'Tristana', 'Veigar', 'Yuumi']
const Void = [
  'Belveth',
  'Chogath',
  'Khazix',
...
export default { champions, regions }
